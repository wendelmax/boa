...
//!
//! ```rust
//! use boa_engine::performance::{PerformanceMonitor, PerformanceMetrics};
...
//! monitor.record_gc_event(Duration::from_millis(10));
//!
...
//!
//! ```rust
//! use boa_engine::performance::{PerformanceMonitor, PerformanceReport};
//!
//! let mut monitor = PerformanceMonitor::new();
//! monitor.start_execution();
//!
...
//!
//! ```rust
//! use boa_engine::performance::{PerformanceMonitor, PerformanceConfig};
//!
...
///
/// ```rust
/// use boa_engine::performance::PerformanceMetrics;
/// use std::time::Duration;
///
...
///
/// ```rust
/// use boa_engine::performance::PerformanceMonitor;
/// use std::time::Duration;
///
/// let mut monitor = PerformanceMonitor::new();
/// 
...
/// monitor.record_gc_event(Duration::from_millis(5));
/// 
